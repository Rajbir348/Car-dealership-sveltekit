...
export const actions = {
    registerDealership: async ({ request, cookies}) => {
        ...
        const res = await fetch('https://car-dealership-management-api.onrender.com/api/auth/signup/dealership', {
            method: 'POST',
            headers: {
    ...
    registerUser: async ({ request, cookies}) => {
        ...
        const res = await fetch('https://car-dealership-management-api.onrender.com/api/auth/signup/user', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
