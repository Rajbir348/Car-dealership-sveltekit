...
export const actions = {
    loginUser: async ({ request, cookies}) => {
        ...
        const res = await fetch('https://car-dealership-management-api.onrender.com/api/auth/login/user', {
            method: 'POST',
            headers: {
    ...
    loginDealership: async ({ request, cookies}) => {
        ...
        const res = await fetch('https://car-dealership-management-api.onrender.com/api/auth/login/dealership', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
